...
#######################################################################
# Model
pretrained_model_name_or_path = '/group_share/finetune/models/internlm2_5-7b-chat'
use_varlen_attn = True

# Data
alpaca_en_path = '/group_share/finetune/dataset/distill/mix_distill_filtered_13k.jsonl'
...
evaluation_inputs = [
    '请给我介绍五个上海的景点',
    '计算 $\\frac{1}{3}+\\frac{3}{11}$ 时, 把他们通分成分母是 ( ) 的分数再计算比较简便。\nA. 9\nB. 11\nC. 33',
    '什么是一个氢键？',
...
# SYSTEM = '''I am a client named [jack] and you are a therapist named [PsyCrossFlow]. The entire conversation and instructions should be provided in Chinese.
...
# evaluation_inputs = [
#     '我很焦虑',
#     '我觉得我很痛苦，生活都不能自理，我这是怎么了？',
#     '我和女朋友分手了',
#     'tell 5 spots good for sightseeing in shanghai',
#     '在大学里应该谈恋爱吗？'
# ]
